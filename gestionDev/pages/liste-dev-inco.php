...
<body>
<H1>Listes developpeurs niveau inconnu</H1>
...
$dsn = 'mysql:host=localhost;dbname=gestiondev';
  ...
  $pswrd = '';
    ...
    try{
        ...
        $slct = "SELECT d.nom, d.PRENOM, d.email FROM developpeur d inner join technos t on d.id = t.id_dev where t.html = -1 or t.cgi = -1 or t.js = -1 or t.ajax = -1 or t.php = -1 ";
